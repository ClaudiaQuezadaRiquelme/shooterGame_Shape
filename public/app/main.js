...
const OPPONENT_HEIGHT = 5,
    OPPONENT_PICTURE = "assets/img/characters/char_01.png", // "assets/img/malo.png"
    ...
    MIN_TOUCHMOVE = 20,
    PLAYER_HEIGHT = 5,
    PLAYER_PICTURE = "assets/img/characters/PlayerGamming.png", // "assets/img/bueno.png"
    PLAYER_PICTURE_DEAD = "assets/img/bueno_muerto.png",
    PLAYER_SPEED = 20,
    PLAYER_WIDTH = 5,
    SHOT_HEIGHT = 1.5,
    SHOT_SPEED = 20,
    SHOT_PICTURE_PLAYER = "assets/img/characters/PlayerBall.png", // "assets/img/shot1.png"
    SHOT_PICTURE_OPPONENT = "assets/img/characters/EnemyBall.png", // "assets/img/shot2.png"
    SHOT_WIDTH = 1.8; // 1.5
